...
stargazer(wc_prematch_models,   # list of linear models 
          ...
          title = "Table 3: Impact of Training on Working Conditions Index - Before Matching",
          covariate.labels = c("Trainee Status", "Supervisor's work experience", 
                               "Comparison Supervisor = Female",
                               "Trainee status*Supervisor's work experience"),
          omit = c("sup_age", "sup_educ", "sup_marital_status", "lo_age", 
                   "lo_gender", "lo_educ", "lo_marital_status", "factory_code"),  # Omit the variable from the main table
...
note_text <- '<div style="max-width: 92%; text-align: left; margin: 0.5; font-size: 14px; line-height: 1.4; margin-top: 5px; padding-top: 0px;">
              ...
              Supervisor and line operator specific characteristics are controlled for in all regressions.
...
stargazer(mp_prematch_models,  # list of linear models 
          ...
          title = "Table 4: Impact of Training on Management Practices Index - Before Matching", 
          covariate.labels = c("Trainee Status", "Supervisor's work experience", 
                               "Comparison Supervisor = Female",
                               "Trainee status*Supervisor's work experience"),
          omit = c("sup_age", "sup_educ", "sup_marital_status", "lo_age", 
...
stargazer(wc_postmatch_models,  # list of linear models post matching
          ...
          dep.var.caption = "Standardized values of working conditions index",
          title = "Table 5: Impact of Training on Working Conditions Index - After Matching",
          covariate.labels = c("Trainee Status", "Supervisor's work experience", 
                               "Comparison Supervisor = Female", 
                               "Trainee status*Supervisor's work experience"),
          omit = c("sup_age", "sup_educ", "sup_marital_status", "lo_age", 
...
# Define the note to include CSS styling for text wrapping, width constraints and space
note_text <- '<div style="max-width: 69%; text-align: left; margin: 0.5; font-size: 14px; line-height: 1.4; margin-top: 5px; padding-top: 0px;">
...
stargazer(mp_postmatch_models,  # list of linear models post matching
          ...
          column.separate = c(2,2),
          dep.var.caption = "Standardized values of management practices index",
          title = "Table 6: Impact of Training on Management Practices Index - After Matching", 
          covariate.labels = c("Trainee Status", "Supervisor's work experience", 
                               "Comparison Supervisor = Female", 
                               "Trainee status*Supervisor's work experience"),
          omit = c("sup_age", "sup_educ", "sup_marital_status", "lo_age", 
...
# Define the note to include CSS styling for text wrapping, width constraints and space
note_text <- '<div style="max-width: 63%; text-align: left; margin: 0.5; font-size: 14px; line-height: 1.4; margin-top: 5px; padding-top: 0px;">
              <p> Columns (1) and (2) show OLS fixed effects regression results after Mahalanobis Distance matching. In addition to all the controls in the
              first model, the second model includes the interaction between the trainee status and supervisors work experience. Columns (3) and (4) show
              results for the same models using Propensity Score matching.
              Supervisor and line operator specific characteristics are controlled for in all regressions.
...
stargazer(wc_logit_models,
          ...
          title = "Table 7: Impact of Training on Working Conditions Index Sub-Components",
          covariate.labels = c("Trainee Status", "Supervisor's work experience", 
                               "Trainee status*Supervisor's work experience"),
          omit = c("sup_age", "sup_educ", "sup_marital_status", "lo_age", 
                   "lo_gender", "lo_educ", "lo_marital_status", "factory_code"),  # Omit the variable from the main table
...
stargazer(mp_logit_models,
          ...
          column.separate = c(2,2,2,2),
          title = "Table 8: Impact of Training on Management Practices Index Sub-Components",
          covariate.labels = c("Trainee Status", "Supervisor's work experience", 
                               "Trainee status*Supervisor's work experience"),
          omit = c("sup_age", "sup_educ", "sup_marital_status", "lo_age", 
                   "lo_gender", "lo_educ", "lo_marital_status", "factory_code"),  # Omit the variable from the main table
